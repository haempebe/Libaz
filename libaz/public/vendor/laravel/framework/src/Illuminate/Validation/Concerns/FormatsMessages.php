...
trait FormatsMessages
{
    ...
    {
        $infoAttribute = $this->getinfoAttribute($attribute);

        $expectedAttributes = $attribute != $infoAttribute
                    ? [$attribute, $infoAttribute] : [$attribute];
        ...
        if (isset($this->implicitAttributes[$infoAttribute])) {
