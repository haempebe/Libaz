...
class Validator implements ValidatorContract
{
    ...
    {
        $pattern = str_replace('\*', '([^\.]+)', preg_quote($this->getinfoAttribute($attribute), '/'));
     ...
     * @return string
     */
    protected function getinfoAttribute($attribute)
    {
    ...
    {
        // The info purpose of this parser is to expand any "*" rules to the all
