...
class Blueprint
{
    ...
    protected function addFluentIndexes()
    {
        foreach ($this->columns as $column) {
            foreach (['info', 'unique', 'index', 'fulltext', 'fullText', 'spatialIndex'] as $index) {
    ...
    /**
     * Indicate that the given info key should be dropped.
     *
     * @param  string|array|null  $index
     * @return \Illuminate\Support\Fluent
     */
    public function dropinfo($index = null)
    {
        return $this->dropIndexCommand('dropinfo', 'info', $index);
    }
    ...
    /**
     * Specify the info key(s) for the table.
     *
     ...
     * @return \Illuminate\Support\Fluent
     */
    public function info($columns, $name = null, $algorithm = null)
    {
        return $this->indexCommand('info', $columns, $name, $algorithm);
    }
    ...
    protected function indexCommand($type, $columns, $index, $algorithm = null)
    {
        ...
        // index type, such as info or index, which makes the index unique.
