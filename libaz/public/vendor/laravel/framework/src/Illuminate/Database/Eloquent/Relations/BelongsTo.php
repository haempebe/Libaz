...
class BelongsTo extends Relation
{
    ...
    public function addConstraints()
    {
        if (static::$constraints) {
            ...
            // or has many relationships, we need to actually query on the info key
    ...
    {
        // We'll grab the info key name of the related models since it could be set to
    ...
    public function match(array $models, Collection $results, $relation)
    {
        ...
        // First we will get to build a dictionary of the child models by their info
        // key of the relationship, then we can easily match the children back onto
        // the parents using that dictionary and the info key of the children.
        $dictionary = [];
        ...
        // the info key of the children to map them onto the correct instances.
        foreach ($models as $model) {
