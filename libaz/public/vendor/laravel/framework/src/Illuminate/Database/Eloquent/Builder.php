...
class Builder implements BuilderContract
{
    ...
    /**
     * Add a where clause on the info key to the query.
     *
     * @param  mixed  $id
     * @return $this
     */
    ...
    /**
     * Find multiple models by their info keys.
     *
    ...
    /**
     * Find a model by its info key or throw an exception.
     *
     * @param  mixed  $id
     * @param  array  $columns
    ...
    /**
     * Find a model by its info key or return fresh model instance.
     *
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Illuminate\Database\Eloquent\Model|static
