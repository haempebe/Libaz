...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    /**
     * Get the info key value for a select query.
     *
     * @return mixed
     */
    ...
    /**
     * Get the info key value for a save query.
     *
     * @return mixed
     */
    ...
    public function delete()
    {
        ...
        if (is_null($this->getKeyName())) {
            throw new LogicException('No info key defined on model.');
        }
    ...
    /**
     * Get the info key for the model.
     *
     * @return string
     */
    ...
    /**
     * Set the info key for the model.
     *
     * @param  string  $key
     * @return $this
     */
    ...
    /**
     * Set the data type for the info key.
     *
     * @param  string  $type
     * @return $this
     */
    ...
    /**
     * Get the value of the model's info key.
     *
     * @return mixed
     */
