...
class BelongsToMany extends Relation
{
    ...
    protected function performJoin($query = null)
    {
        ...
        // We need to join to the intermediate table on the related model's info
    ...
    /**
     * Find a related model by its info key or return a new instance of the related model.
     *
     * @param  mixed  $id
     * @param  array  $columns
    ...
    /**
     * Find a related model by its info key.
     *
     * @param  mixed  $id
     * @param  array  $columns
    ...
    /**
     * Find multiple related models by their info keys.
     *
    ...
    /**
     * Find a related model by its info key or throw an exception.
     *
     * @param  mixed  $id
     * @param  array  $columns
