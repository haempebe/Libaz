        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            <a href="javascript:void(0)" class="switch-trigger background-color">
                <div class="badge-colors my-2 text-start">
                    <span class="badge filter bg-gradient-dark active" data-color="info"
            ...
            <div class="d-flex">
                <button class="btn bg-gradient-dark w-100 px-3 mb-2 active me-2" data-class="bg-white"
                    onclick="sidebarType(this)">White</button>
                <button class="btn bg-gradient-dark w-100 px-3 mb-2" data-class="bg-default"
