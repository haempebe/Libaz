                ...
                <div class="row">
                    @foreach ($allBuku as $item)
                        <div class="col-xxl-3 col-md-4 col-6 mb-3">
                            <div class="card shadow-none border" style="min-height: 450px">
                                <img src="{{ asset('img/cover/' . $item->cover) }}" class="img-fluid rounded"
                                    style="object-fit:contain;max-height:250px" alt="...">
                                <div class="card-body">
                                    <p class="card-title text-sm">{{ $item->penulis->name }}</p>
                                    <h6 class="card-title">{{ Str::limit($item->name, 25) }}</h6>
