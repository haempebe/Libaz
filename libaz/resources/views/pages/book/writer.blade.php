...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                <form class="d-inline" onsubmit="return confirm('sure to delete this data')"
                                                    action="{{ url('book/writer/' . $item->id . '/delete') }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="col-md-4">
                <div class="card">
                    <form method="POST" action="{{ route('book.writer.perform') }}">
                        @csrf
                        <div class="card-header border-radius-lg pb-0">
                            <p class="mb-0">+ Add New writers</p>
                        </div>
