...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
                                    ...
                                    @foreach ($allRak as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">Rak nomor {{ $item->no }}</span>
                                            </td>
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                <form class="d-inline" onsubmit="return confirm('sure to delete this data')"
                                                    action="{{ url('book/bookshelf/' . $item->id . '/delete') }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="col-md-4">
                <div class="card">
                    <form method="POST" action="{{ route('book.bookshelf.perform') }}">
                        @csrf
                        <div class="card-header border-radius-lg pb-0">
                            <p class="mb-0">+ Add New Bookshelf</p>
                        </div>
                        <div class="card-body pb-0">
                            <div class="form-group">
                                <label for="text-input" class="form-control-label">Bookshelf</label>
                                <input class="form-control" type="number" name="no" min="1" value="{{$i}}">
                                @error('nomor_rak')
