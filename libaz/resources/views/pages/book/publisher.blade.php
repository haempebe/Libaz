@section('topTitle', 'Publishers')
@extends('layouts.app', ['class' => 'g-sidenav-show bg-gray-100'])

@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Publishers'])
    <div id="alert">
    ...
    <div class="container-fluid py-4">
        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                <form class="d-inline" onsubmit="return confirm('sure to delete this data')"
                                                    action="{{ url('book/publisher/' . $item->id . '/delete') }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="col-md-4">
                <div class="card">
                    <form method="POST" action="{{ route('book.publisher.perform') }}">
                        @csrf
                        <div class="card-header border-radius-lg pb-0">
                            <p class="mb-0">+ Add New Publisher</p>
                        </div>
