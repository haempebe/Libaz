                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="javascript:;" class="btn btn-xs bg-gradient-success mb-0 font-weight-bold text-xs">
                                            <span class="btn-inner--icon"><i class="fas fa-edit"></i></span>
                                            <span class="btn-inner--text"> Edit</span>
                                        </a>
                                        <form class="d-inline" onsubmit="return confirm('sure to delete this data')" action="{{ url('category/' . $item->id . '/delete') }}" method="post">
                                            @csrf
                                            @method('DELETE')
