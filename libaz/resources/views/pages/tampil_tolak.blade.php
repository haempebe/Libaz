            ...
            <div class="col-lg-4">
                <div class="card-body">
                    ...
                    <form action="{{-- route('penolakan') --}}" method="POST">
                        ...
                        <textarea class="form-control" name="penolakan" id="informasi_penolakan" cols="30" rows="10"></textarea>

                       <button class="btn btn-danger mt-3" type="submit">Kirim</button>
                    </form>
                </div>
            </div>
        </div>
